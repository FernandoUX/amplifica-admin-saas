                      ...
                      <tr key={empresa.id} className="border-b border-neutral-100 hover:bg-neutral-50 transition-colors">
                        ...
                        <td className="w-8 py-3 pr-2">
                          <RowMenu actions={[
                            ...
                            ...(canEditar("Empresas") ? [{ label: "Editar", onClick: () => setEditEmpresa({ ...empresa }) }] : []),
                            ...(canDeshabilitar("Empresas") ? [{ label: "Deshabilitar", onClick: () => setAlertEmpresa(empresa), variant: "danger" as const }] : []),
                          ]} />
                        </td>
