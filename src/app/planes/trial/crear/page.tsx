...
const initial: FormState = { nombre: "", descripcion: "", duracionDias: "", modulos: [], pedidosMax: "", sucursalesMax: "", esDefault: false };

export default function CrearTrialConfigPage() {
  ...
  return (
    <MainLayout narrow>
      <div className="flex flex-col min-h-full">
        <PageHeader
          breadcrumb={[{ label: "Inicio", href: "/" }, { label: "Planes", href: "/planes" }, { label: "Crear configuración de trial" }]}
          title="Crear configuración de trial"
          description="Define una plantilla de trial con duración, módulos y límites"
        />
      ...
      <Toast open={toast} onClose={() => setToast(false)} type="success" title="¡Configuración creada!" message="La configuración de trial se ha creado correctamente." />
    </MainLayout>
  );
}
